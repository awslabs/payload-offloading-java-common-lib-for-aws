 ...
 */
@NotThreadSafe
public abstract class ExtendedClientConfigurationBase<T extends ExtendedClientConfigurationBase> {
	...
	private int payloadSizeThreshold = ExtendedClientConstants.DEFAULT_PAYLOAD_SIZE_THRESHOLD;

	protected ExtendedClientConfigurationBase() {
		s3 = null;
		s3BucketName = null;
		sseAwsKeyManagementParams = null;
	}

	protected ExtendedClientConfigurationBase(ExtendedClientConfigurationBase other) {
	 ...
	 *
	 * @param s3
	 *            Amazon S3 client which is going to be used for storing large payload.
	 *
	 * @param s3BucketName
	 *            Name of the bucket which is going to be used for storing large payload.
	 ...
	 *
	 * @param s3
	 *            Amazon S3 client which is going to be used for storing large payloads.
	 *
	 * @param s3BucketName
	 *            Name of the bucket which is going to be used for storing large payloads.
	 *            The bucket must be already created and configured in s3.
	 *
	 * @return the updated ExtendedClientConfiguration object.
	 */
	public T withLargePayloadSupportEnabled(AmazonS3 s3, String s3BucketName) {
	 ...
	 * @return the updated ExtendedClientConfiguration object.
	 */
	public T withLargePayloadSupportDisabled() {
	 ...
	 *
	 * @param sseAwsKeyManagementParams
	 ...
	 * @return the updated ExtendedClientConfiguration object
	 */
	public T withSSEAwsKeyManagementParams(SSEAwsKeyManagementParams sseAwsKeyManagementParams) {
	 ...
	 *
	 * @param payloadSizeThreshold
	 *            Payload size threshold to be used for storing in Amazon S3.
	 *            Default: 256KB.
	 */
	 ...
	 * @return the updated ExtendedClientConfiguration object.
	 */
	public T withPayloadSizeThreshold(int payloadSizeThreshold) {
	 ...
	 *            Whether or not all payloads regardless of their size
	 ...
	 * @return the updated ExtendedClientConfiguration object.
	 */
	public T withAlwaysThroughS3(boolean alwaysThroughS3) {
